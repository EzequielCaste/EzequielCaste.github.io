          ...
          <div className="columns">
            ...
            <div className="column is-desktop">
              ...
              <div className="subtitle is-4 is-size-5-touch">
                <p>I'm a self-taught Web Developer and English/Spanish translator.</p>
              </div>
              <div className="subtitle is-4 is-size-5-touch">
                <p>I started building websites as a hobby, back when blogs were starting out.</p>
              </div>
              <div className="subtitle is-4 is-size-5-touch">
                <p>Back-end is where I am the most comfortable and what I enjoy the most!</p>
              </div>
              <div className="subtitle is-1 is-size-3-touch">                
                ...
                <a href="https://twitter.com/Ezequiel_Caste" rel="noopener noreferrer" target="_blank">
                  <i className="fab fa-twitter ml-3"></i>
                </a>
                <a href="#contact">
                  <i className="far fa-envelope ml-3"></i>
                </a>                      
                <a href="https://codepen.io/ezequiel_/" id="profile-link" rel="noopener noreferrer" target="_blank">
                  <i className="fab fa-codepen ml-3"></i>
                </a>
                <a href="https://www.linkedin.com/in/ezequiel-castellanos-a9ab6b1b8/" rel="noopener noreferrer" target="_blank">
